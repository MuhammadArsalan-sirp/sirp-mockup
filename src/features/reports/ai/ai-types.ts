...
export type RiskTier = "auto" | "review" | "blocked"

export type DeliveryStatus = "pending" | "approved" | "held" | "sent" | "failed"

/** One generated-but-not-yet-delivered edition of a scheduled report. */
export type PendingEdition = {
  ...
  riskTier: RiskTier
  /** Why it needs a human — empty for auto-send tiers. */
  reviewReasons: string[]
  /** What changed since the last edition went out. */
  changesSinceLast: { label: string; detail: string; adverse: boolean }[]
  /** Generated narrative awaiting sign-off. */
  narrativeClaims: Claim[]
...
export type AutonomyPolicy = {
  ...
  description: string
  tier: RiskTier
  /** Locked policies can't be relaxed from this screen. */
  locked?: boolean
}
