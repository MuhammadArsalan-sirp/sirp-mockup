...
import { ThreatIntelFilterPopover } from "./threat-intel-filter-popover"
import { ThreatIntelViewSettings } from "./threat-intel-view-settings"
...
export function ThreatIntelToolbar({
  table,
  viewMode,
  onViewModeChange,
  listConfig,
  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      ...
      <ThreatIntelFilterPopover table={table} />
    </div>
  )
}
