...
import type { ViewMode } from "./threat-intel-toolbar"
import type {
  BoardField,
  BoardViewConfig,
  GroupByField,
...
function GridSettings({ table }: { table: Table<ThreatIntel> }) {
...
export function ThreatIntelViewSettings({
  currentView,
  table,
  listConfig,
  onListConfigChange,
