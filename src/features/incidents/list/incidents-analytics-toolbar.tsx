...
import { Bell, Briefcase, CalendarIcon, Flame, Layers } from "lucide-react"
...
export type AnalyticsRecordType = "all" | "alert" | "case" | "incident"
...
export function IncidentsAnalyticsToolbar({
  recordType,
  onRecordTypeChange,
  timeRange,
  onTimeRangeChange,
  ...
  return (
    <div className="flex items-center justify-between gap-2">
      ...
      <Segment<AnalyticsRecordType>
        options={["all", "alert", "case", "incident"]}
        active={recordType}
