...
export const recordTypeOptions: readonly FacetedOption[] = [
...
/** Friendly labels for the active-filters chip row. */
export const filterLabels = {
  recordType: {
    label: "State",
    values: Object.fromEntries(recordTypeOptions.map((o) => [o.value, o.label])),
  },
  severity: {
    label: "Severity",
